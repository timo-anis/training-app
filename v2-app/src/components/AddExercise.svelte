...
<style>
  .add-ex-trigger {
    ...
    padding: 14px;
    border-radius: 14px;
    border: 1px dashed rgba(var(--c-fg), 0.14);
  ...
  .add-ex-input::placeholder { color: rgba(var(--c-fg), 0.20); }
  .add-ex-input:focus { border-color: rgba(var(--c-fg), 0.25); }
  ...
  .btn-cancel:active { background: rgba(var(--c-surface-b), 0.85); }
  ...
  .btn-confirm:not(:disabled):active {
    ...
    border-color: rgba(var(--c-fg), 0.35);
  }
