...
export const EXERCISE_LIBRARY: ExerciseEntry[] = [
  ...
  { name: 'Conditioning',          aliases: ['conditioning', 'cardio', 'cond'] },
  ...
  { name: 'Incline DB Bench Press',     aliases: ['incline db bench', 'incline dumbbell bench press', 'incline dumbell bench press', 'incline db', 'incline db bench press'] },
  { name: 'Low Incline DB Bench Press', aliases: ['low incline db bench', 'low incline dumbbell bench press', 'low incline', 'low incline db bench press'] },
  { name: 'Push-Up',                    aliases: ['pushup', 'push-up', 'push up', 'pushups', 'strict push-up', 'strict push-ups'] },
  ...
  { name: 'Seated DB Shoulder Press',   aliases: ['seated db shoulder press', 'seated dumbbell shoulder press', 'seated dumbbell press', 'seated press', 'db shoulder press', 'db strict press'] },
  ...
  { name: 'Bent-Over Rear Delt Raise',  aliases: ['bent-over rear delt raise', 'rear delt raise', 'rear delt fly', 'reverse fly', 'rear delt', 'bent raise'] },
  ...
  { name: 'Neutral Grip Pull-Up',      aliases: ['neutral grip pull-up', 'neutral grip pull up', 'neutral pull-up'] },
  { name: 'Wide Grip Strict Pull-Up',   aliases: ['wide grip strict pull-up', 'wide grip pull-up', 'wide grip pull up', 'wide pull-up', 'wide grip strict pull-ups'] },
  ...
  { name: 'False Grip Ring Pull-Up',    aliases: ['false grip ring pull-up', 'ring pull-up', 'ring pull up', 'false ring pull-up', 'false ring pull up'] },
  ...
  { name: 'Barbell Seal Row',           aliases: ['seal row', 'barbell seal row', 'barebell seal row'] },
  { name: 'DB Seal Row',               aliases: ['db seal row', 'dumbbell seal row', 'dumbell seal row'] },
  ...
  { name: 'Barbell Shrug',              aliases: ['barbell shrug', 'shrug', 'shrugs', 'barebell shrug', 'shurgs'] },
  ...
  { name: 'Romanian Deadlift',          aliases: ['rdl', 'romanian deadlift', 'romanian dl', 'one leg romanian deadlift', 'single leg rdl', 'single-leg rdl'] },
  ...
  { name: 'Barbell Reverse Lunge',     aliases: ['barbell reverse lunge', 'barebell reverse lunge'] },
  ...
  { name: 'Pistol Squat',              aliases: ['pistol squat', 'pistol squats'] },
  { name: 'Bulgarian Split Squat',      aliases: ['bulgarian split squat', 'bss', 'bulgarian', 'split sq'] },
  { name: 'Rear-Foot Elevated Split Squat', aliases: ['rear-foot elevated split squat', 'rear foot elevated split squat', 'rear foot', 'rfess', 'back rack rear elevated split squat'] },
  ...
  // ── Core ────────────────────────────────────────────────────
  { name: 'Ab Wheel Rollout',           aliases: ['ab wheel rollout', 'ab wheel', 'ab roller', 'ab roll out'] },
  { name: 'Plank',                      aliases: ['plank'] },
  { name: 'Side Plank',                 aliases: ['side plank'] },
  { name: 'Crunch',                     aliases: ['crunch', 'crunches'] },
  { name: 'Weighted Sit-Up',           aliases: ['weighted sit-up', 'weighted situp', 'weighted sit up'] },
  ...
  { name: 'Dragon Flag',                aliases: ['dragon flag', 'dragon fly', 'dragonfly'] },
  ...
  { name: 'Pike Push-Up',               aliases: ['pike push-up', 'pike push up', 'pike pushup', 'pike push-ups'] },
